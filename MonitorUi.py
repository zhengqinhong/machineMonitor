...
class AutoMonitor(QtWidgets.QMainWindow):
    ...
    def setupUi(self, Form):
        ...
        Form.resize(1612, 800)
        self.widget = QtWidgets.QWidget(Form)
        self.widget.setGeometry(QtCore.QRect(800, 0, 771, 800))
        self.widget.setObjectName("widget")
        self.comboBox = QtWidgets.QComboBox(self.widget)
        self.comboBox.setGeometry(QtCore.QRect(30, 25, 190, 30))
        font = QtGui.QFont()
        ...
        self.label.setGeometry(QtCore.QRect(30, 70, 190, 30))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        ...
        self.lineEdit.setGeometry(QtCore.QRect(30, 100, 190, 30))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        ...
        self.pushButton.setGeometry(QtCore.QRect(130, 520, 70, 30))
        self.pushButton.setObjectName("pushButton")
        self.pushButton_3 = QtWidgets.QPushButton(self.widget)
        self.pushButton_3.setGeometry(QtCore.QRect(20, 520, 93, 28))
        self.pushButton_3.setObjectName("pushButton_3")
        self.label_2 = QtWidgets.QLabel(self.widget)
        self.label_2.setGeometry(QtCore.QRect(20, 590, 41, 16))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(self.widget)
        self.label_3.setGeometry(QtCore.QRect(60, 590, 72, 15))
        self.label_3.setText("")
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(self.widget)
        self.label_4.setGeometry(QtCore.QRect(60, 620, 72, 15))
        self.label_4.setText("")
        self.label_4.setObjectName("label_4")
        self.label_5 = QtWidgets.QLabel(self.widget)
        self.label_5.setGeometry(QtCore.QRect(20, 620, 61, 16))
        self.label_5.setObjectName("label_5")
        self.label_6 = QtWidgets.QLabel(self.widget)
        self.label_6.setGeometry(QtCore.QRect(60, 650, 72, 15))
        ...
        self.lineEdit_3.setGeometry(QtCore.QRect(30, 240, 190, 30))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        ...
        self.label_9.setGeometry(QtCore.QRect(30, 210, 190, 30))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        ...
        self.ProcessStart.setGeometry(QtCore.QRect(240, 730, 93, 28))
        self.ProcessStart.setObjectName("ProcessStart")
        self.ProcessStop = QtWidgets.QPushButton(self.widget)
        self.ProcessStop.setGeometry(QtCore.QRect(360, 730, 93, 28))
        self.ProcessStop.setObjectName("ProcessStop")
        self.widget_2 = QtWidgets.QWidget(self.widget)
        self.widget_2.setGeometry(QtCore.QRect(240, 320, 441, 261))
        ...
        self.frame.setGeometry(QtCore.QRect(240, 140, 341, 171))
        ...
        self.pushButton_savePath.setGeometry(QtCore.QRect(30, 40, 151, 31))
        ...
        self.frame_2.setGeometry(QtCore.QRect(250, 40, 251, 91))
        ...
        self.frame_3.setGeometry(QtCore.QRect(240, 600, 281, 80))
        self.frame_3.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_3.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_3.setObjectName("frame_3")
        self.label_Resolution = QtWidgets.QLabel(self.frame_3)
        self.label_Resolution.setGeometry(QtCore.QRect(10, 10, 81, 30))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        self.label_Resolution.setFont(font)
        self.label_Resolution.setObjectName("label_Resolution")
        self.lineEdit_Resolution = QtWidgets.QLineEdit(self.frame_3)
        self.lineEdit_Resolution.setGeometry(QtCore.QRect(90, 10, 101, 20))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        ...
        self.label.setBuddy(self.lineEdit_Resolution)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Pixel Format"))
        self.pushButton.setText(_translate("Form", "Capture"))
        self.pushButton_3.setText(_translate("Form", "Fresh"))
        self.label_2.setText(_translate("Form", "RGB:"))
        self.label_5.setText(_translate("Form", "region:"))
        self.label_7.setText(_translate("Form", "size:"))
        self.label_9.setText(_translate("Form", "Color Space"))
        ...
        self.label_29.setText(_translate("Form", "阈值保存路径："))
